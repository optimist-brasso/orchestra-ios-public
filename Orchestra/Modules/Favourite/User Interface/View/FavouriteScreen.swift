...
class FavouriteScreen: BaseScreen {
    ...
    private(set) lazy var searchBar: CustomSearchBar = {
        ...
        customSearchBar.searchTextField.inputAccessoryView = UIView()
    ...
    override func create() {
        ...
        searchStackView.fillSuperView(inset: UIEdgeInsets(top: 14, left: 22, bottom: 14, right: 29))
